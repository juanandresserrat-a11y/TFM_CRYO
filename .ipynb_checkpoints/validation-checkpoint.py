...
Fuentes de los rangos de referencia:
  Sharma et al. Emerg. Top. Life Sci. 2023 [20]
  Glushkova et al. J. Cell Biol. 2026
  Pinigin, Membranes 2022 [21]
...
def benchmark_thickness(membrane: "BicapaCryoET") -> Dict:
    ...
    sup_z = np.array([l.glycerol_pos[26] for l in sup])
    inf_z = np.array([l.glycerol_pos[26] for l in inf])
...
def benchmark_order_parameter(membrane: "BicapaCryoET") -> Dict:
    ...
    Referencia: Piggot et al. JCTC 2017 [20], Bartos et al. 2025 [1].
...
def benchmark_interdigitation(membrane: "BicapaCryoET") -> Dict:
    ...
    Referencia: Chaisson et al. JCIM 2025 [4].
    """
