...
Referencias:
  [10]  Helfrich, Z. Naturforsch. C 1973 – energía elástica de membrana
  [21]  Pinigin, Membranes 2022 – espectro de fluctuaciones
  [3]  Chakraborty et al. PNAS 2020 – kc dependiente de composición
  [20]  Piggot et al. J. Chem. Theory Comput. 2017 – parámetro S_CH
  [26]  Smith et al. LiveCoMS 2019 – kinks en dobles enlaces
"""
...
def bending_modulus_from_composition(
    ...
    CHOL y SM condensan las cadenas acil, aumentando kc [3].
    Rango resultante: 18–45 kBT·nm², coherente con Pinigin 2022 [21].
...
def generate_tail(
    ...
    LiveCoMS 2019 [26] y calcula S_CH por segmento C–C según Piggot et
    al. J. Chem. Theory Comput. 2017 [20].
