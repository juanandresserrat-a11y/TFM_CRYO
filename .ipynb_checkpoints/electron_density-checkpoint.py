...
def electron_density_volume(
    ...
    for l in todos:
        ...
        z_h_rel = (l.head_pos[26] - z_ref) / 10.0
        z_g_rel = (l.glycerol_pos[26] - z_ref) / 10.0
        ...
        for iz, zc in enumerate(z_centers):
            ...
            if l.tail1 and len(l.tail1) > 2:
                z_tail_end_rel = (l.tail1[-1][26] - z_ref) / 10.0
